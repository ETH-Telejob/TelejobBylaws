...
The Executive Board (EB) is authorized by the GA to carry out all acts that further the purposes of the Organization. It has the most extensive power to manage the Association's day-to-day affairs. The EB decides with a simple majority of its members at a meeting. 
...
\item {\bf Auditors}\\
The finances of the Organization is audited by a professional auditor, who cannot be a member in any other organ of the Organization.
...
These Bylaws were last changed on XXXXXX by the EM of the Organization. They replace the previous version from XXXXX. They take effect immediately.
